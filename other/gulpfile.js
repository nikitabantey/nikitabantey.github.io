...
gulp.task('scripts', function () {
    return gulp.src([
    './src/js/default/avoid.console.error.js',
    './src/js/default/classy-nav.js',
    'node_modules/owl.carousel2/dist/owl.carousel.min.js',
    'node_modules/wowjs/dist/wow.min.js',
    'node_modules/magnific-popup/dist/jquery.magnific-popup.min.js',
    'node_modules/jquery-waypoints/waypoints.min.js',
    ...
    'node_modules/jarallax/dist/jarallax.min.js',
    'node_modules/jarallax/dist/jarallax-video.min.js',
    './src/js/default/jquery.scrollup.min.js',
    'node_modules/jquery-countdown/dist/jquery.countdown.min.js',
    'node_modules/jquery-nice-select/js/jquery.nice-select.min.js',
    './src/js/default/jquery.one-page-nav.js',
    './src/js/default/jquery.barfiller.js',
    './src/js/default/mail.js',
    'node_modules/velocity-animate/velocity.min.js',
    'node_modules/velocity-animate/velocity.ui.min.js',
    'node_modules/jquery-animated-headlines/dist/js/jquery.animatedheadline.min.js'
  ])
...
gulp.task('default', ['js', 'scripts', 'css', 'fafonts', 'elefonts', 'sass']);